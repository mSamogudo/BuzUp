...
/// Lightweight logger tagged "BuzUpPos" (visible in Android logcat and
/// macOS/iOS Console as a unified subsystem) plus a "[BUZUP_POS]" prefix
/// in stdout so it shows up under `flutter run`.
class Log {
  Log._();

  static const _name = 'BuzUpPos';
  static const _tag = 'BUZUP_POS';
