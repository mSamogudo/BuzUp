...
const PT = {
  ...
  cardMethod: "Cartão Visa / Mastercard",
  cardPhoneHint: "O bilhete é enviado por SMS para este número.",
  cardNotice: "Vai ser encaminhado para a página segura do operador de cartões. Quando terminar, volta aqui automaticamente.",
  cardRedirecting: "A encaminhar para o pagamento…",
  returnChecking: "A confirmar o pagamento…",
  returnPendingTitle: "Pagamento em confirmação",
  returnPendingText: "Ainda não recebemos a confirmação. Se já pagou, o bilhete chega por SMS dentro de minutos — não precisa de pagar outra vez.",
  returnFailedTitle: "Pagamento não concluído",
  returnFailedText: "O pagamento não foi concluído e a reserva foi libertada. Pode tentar de novo.",
  tryAgain: "Tentar de novo",
  checkAgain: "Verificar outra vez",
  ticketIssued: "Bilhete emitido",
  ticketIssuedText: "Pagamento confirmado. Enviámos o link do bilhete por SMS para o número indicado — guarde o PDF no telemóvel e apresente o QR ao embarcar.",
  pendingTitle: "Pagamento pendente",
  pendingText: "Confirme o pagamento no seu telemóvel. Assim que for confirmado, o bilhete chega por SMS — não precisa de pagar outra vez.",
...
const EN: Record<keyof typeof PT, string> = {
  ...
  cardPhoneHint: "The ticket is sent by SMS to this number.",
  cardNotice: "You will be taken to the card operator's secure page. When you finish, you come back here automatically.",
  cardRedirecting: "Taking you to the payment page…",
  returnChecking: "Confirming your payment…",
  returnPendingTitle: "Payment being confirmed",
  returnPendingText: "We have not received the confirmation yet. If you have paid, the ticket arrives by SMS within minutes — no need to pay again.",
  returnFailedTitle: "Payment not completed",
  returnFailedText: "The payment was not completed and the reservation was released. You can try again.",
  tryAgain: "Try again",
  checkAgain: "Check again",
  ticketIssued: "Ticket issued",
  ticketIssuedText: "Payment confirmed. We sent the ticket link by SMS to the number provided — save the PDF on your phone and show the QR when boarding.",
  pendingTitle: "Payment pending",
  pendingText: "Confirm the payment on your phone. As soon as it is confirmed, the ticket arrives by SMS — no need to pay again.",
