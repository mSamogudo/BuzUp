...
class VehicleSerializer(serializers.ModelSerializer):
    class Meta:
        model = Vehicle
        fields = ("id", "uuid", "registration", "make", "model_name", "seated_capacity", "standing_capacity", "status", "created_at", "updated_at")
...
class DriverSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Driver
        fields = ("id", "uuid", "user_id", "user_display", "full_name", "phone", "license_number", "status", "created_at", "updated_at")
    ...
    def _ensure_user(self, validated_data: dict, instance: Driver | None = None) -> User | None:
        ...
        if user is None:
            user = User.objects.create(
                username=username,
                email=f"{phone}@driver.buzup.co.mz",
                phone=phone,
    ...
    def create(self, validated_data):
        ...
        user = self._ensure_user(validated_data, driver)
        if user:
            driver.user = user
