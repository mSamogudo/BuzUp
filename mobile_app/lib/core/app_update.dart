...
/// Asks the backend if a newer published passenger release exists and, if so,
/// shows an update prompt. Mandatory updates cannot be dismissed. Failures are
/// swallowed so a check never blocks the app.
        ...
        Future<void> doUpdate() async {
          ...
          try {
            if (Platform.isAndroid) {
              // Download the APK (with progress) and hand it straight to the
              // system installer (1-tap) instead of bouncing through the browser.
              ...
              await _installerChannel.invokeMethod('installApk', {
                ...
                'fileName': 'buzup-passageiro-$newVersion.apk',
              });
              // Installer opened; the user confirms in the system UI.
            } else {
