...
const PT = {
  ...
  soldOut: "Esgotado",
  soldOutTitle: "Sem lugares nesta data.",
  soldOutLead: "As partidas deste dia já não têm {n} lugares livres no mesmo autocarro.",
  soldOutFewer: "Procurar {n} lugares",
  soldOutFewerOne: "Procurar 1 lugar",
  soldOutOtherDay: "Escolher outro dia",
  ...
  payFailTitle: "O pagamento não foi concluído.",
  payFailSafe: "Não foi cobrado nada. O saldo da sua carteira está intacto.",
  payFailRetry: "Tentar pagar de novo",
  payFailRestart: "Começar uma compra nova",
...
const EN: Record<keyof typeof PT, string> = {
  ...
  soldOut: "Sold out",
  soldOutTitle: "No seats on this date.",
  soldOutLead: "Departures on this day no longer have {n} free seats on the same bus.",
  soldOutFewer: "Look for {n} seats",
  soldOutFewerOne: "Look for 1 seat",
  soldOutOtherDay: "Pick another day",
  ...
  payFailTitle: "The payment did not go through.",
  payFailSafe: "Nothing was charged. Your wallet balance is untouched.",
  payFailRetry: "Try paying again",
  payFailRestart: "Start a new purchase",
